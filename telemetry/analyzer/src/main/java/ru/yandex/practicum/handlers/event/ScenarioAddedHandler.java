...
public class ScenarioAddedHandler implements HubEventHandler {
    ...
    public void handle(HubEventAvro event) {
        ...
        Scenario scenario = scenarioOpt.orElseGet(() -> scenarioRepository.save(mapToScenario(event)));

        // Идемпотентное обновление: при повторном событии перезаписываем набор условий и действий.
